...
const Sidebar = () => {
    ...
    return (
        <VStack py={'16'} spacing={'4'} boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'}>
            <LinkButton Icon={RiDashboardFill} text={'Dashboard'} url={'/dashboard'} active={location.pathname === '/admin/dashboard'} />
            <LinkButton Icon={RiAddCircleFill} text={'Add Course'} url={'/createcourse'} active={location.pathname === '/admin/createcourse'} />
